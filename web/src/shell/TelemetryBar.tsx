 ...
 * скорость сближения V_сбл, радиальная оценка времени R/V_сбл, прогноз промаха h_cv.
        ...
        <div className="drawer__body">
          ...
          <div className="drawer__col">
            ...
            <dl className="kv">
              ...
              <div data-tip="Радиальная оценка оставшегося времени t_radial = R/V_сбл при текущих скоростях (не точное время до встречи).">
                <dt>R/V_сбл, с</dt>
                <dd>{fmt(nm?.tgo ?? 0, 2)}</dd>
              </div>
              <div data-tip="h_cv — прогноз промаха при неизменных текущих скоростях (прямая экстраполяция до времени наибольшего сближения).">
                <dt>Прогноз h_cv</dt>
                <dd>{fmt(nm?.zem ?? 0, 0)}</dd>
              </div>
              <div data-tip="Угол между вектором скорости ракеты и направлением на точку встречи.">
                <dt>Угол упреждения, °</dt>
              ...
              <div data-tip="ρ = θ̇/θ — нормированная скорость расширения изображения, оптическая оценка V_сбл/R.">
