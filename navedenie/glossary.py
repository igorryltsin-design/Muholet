...
Обозначения:
  - навигационный коэффициент метода пропорционального сближения во всём проекте
...
LAWS: dict[str, Term] = {
    "pn": Term(
        id="pn", rus_full="Метод пропорционального сближения", rus_short="МПС",
    ...
    "tpn": Term(
        id="tpn", rus_full="Истинный метод пропорционального сближения (TPN)", rus_short="истинный МПС",
        symbol="N", unit="безразм.",
    ...
    "apn": Term(
        id="apn", rus_full="МПС с компенсацией нормального ускорения цели", rus_short="",
        symbol="N", unit="безразм.",
        definition="МПС с добавкой, пропорциональной нормальной составляющей ускорения цели.",
    ...
    "pure": Term(
        ...
        formula="ψ = φ (предельный случай МПС при N=1)",
    ...
    "pn_gsn": Term(
        id="pn_gsn", rus_full="МПС по измерениям сенсорного канала ГСН", rus_short="",
        symbol="N", unit="безразм.",
        definition="МПС, где угловая скорость линии визирования восстанавливается из измерений сенсора.",
    ...
    "pn_sched_oracle": Term(
        id="pn_sched_oracle", rus_full="Экспериментальный МПС с переменным навигационным коэффициентом N по точному состоянию",
        rus_short="", symbol="N_sched", unit="безразм.",
        definition="МПС, где N планируются по относительной скорости сближения ρ из точной геометрии.",
    ...
    "pn_sched_sensor": Term(
        id="pn_sched_sensor", rus_full="Экспериментальный МПС с переменным навигационным коэффициентом N по сенсорным измерениям",
        rus_short="", symbol="N_sched", unit="безразм.",
